...
music_list = ['music/retro_tetris.mp3',
              'music/letov.mp3',
              'music/groza.mp3',
              'music/mlechniy.mp3',
...
sc.create_text(500, 30,text="tetris", font=("tetris", 45),fill="red", anchor=NW)
sc.create_text(535, 780,text="score", font=("tetris", 35),fill="white", anchor=NW)
_score = sc.create_text(550, 840,text=str(score), font=("WiGuru 2", 35),fill="white", anchor=NW)
sc.create_text(525, 650,text="record", font=("tetris", 35),fill="white", anchor=NW)
